...
function() {
  ...
  d.addListener = function(a, c) {
    var d,
      ...
      f = "object" == typeof c;
    for (d in e)
      e.hasOwnProperty(d) && -1 === b(e[d], c) && e[d].push(
        f
        ? c
        : {
          listener: c,
    ...
    b(function() {
      for (var b = d.toDashed(e), g = document.querySelectorAll(".js-" + b), h = "data-" + b + "-options", i = 0, j = g.length; j > i; i++) {
        ...
        try {
          ...
          f && f.error("Error parsing " + h + " on " + l.nodeName.toLowerCase() + (
            l.id
            ? "#" + l.id
            : "") + ": " + n);
          continue
...
function(a, b) {
  ...
  g.prototype.layoutPosition = function() {
    ...
    k = b.percentPosition && b.isHorizontal
      ? k / a.height * 100 + "%"
      : k + "px",
    c[i] = k,
    c[j] = "",
  ...
  g.prototype.transition = g.prototype[
    j
      ? "_transition"
      : "_nonTransition"
  ],
...
function(a, b) {
  ...
  function g(a, b) {
    ...
    if (!c)
      return void(h && h.error("Bad element for " + this.constructor.namespace + ": " + (
      c || a)));
    this.element = c,
