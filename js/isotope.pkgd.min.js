 ...
 * Copyright 2015 Metafizzy
 ...
 This javascript is used to filter between photographs. In this case, when you click 'travel', the page will show only the travel photographs.
 */
...
(function(t) {
  ...
  function i(t) {
    ...
    if (t) {
      var r = "undefined" == typeof console
        ? e
        : function(t) {
          console.error(t)
        };
...
function() {
  ...
  o.getListenersAsObject = function(t) {
    ...
    return i instanceof Array && (e = {}, e[t] = i),
    e || i
  },
  o.addListener = function(t, i) {
    var o,
      ...
      r = "object" == typeof i;
    for (o in n)
      n.hasOwnProperty(o) && -1 === e(n[o], i) && n[o].push(
        r
        ? i
        : {
          listener: i,
    ...
    e(function() {
      for (var e = o.toDashed(n), s = document.querySelectorAll(".js-" + e), a = "data-" + e + "-options", u = 0, p = s.length; p > u; u++) {
        ...
        try {
          ...
          r && r.error("Error parsing " + a + " on " + f.nodeName.toLowerCase() + (
            f.id
            ? "#" + f.id
            : "") + ": " + l);
          continue
...
function(t, e) {
  ...
  s.prototype.layoutPosition = function() {
    ...
    s = e.percentPosition && !e.isHorizontal
      ? 100 * (s / t.width) + "%"
      : s + "px",
    i[n] = s,
    i[r] = "";
    ...
    h = e.percentPosition && e.isHorizontal
      ? 100 * (h / t.height) + "%"
      : h + "px",
    i[u] = h,
    i[p] = "",
  ...
  s.prototype.moveTo = f
    ? s.prototype._transitionTo
    : s.prototype.goTo,
  ...
  s.prototype.transition = s.prototype[
    p
      ? "_transition"
      : "_nonTransition"
  ],
...
function(t, e) {
  ...
  function s(t, e) {
    ...
    if (!i)
      return a && a.error("Bad element for " + this.constructor.namespace + ": " + (
      i || t)),
      void 0;
    this.element = i,
...
function(t, e) {
  ...
  o.prototype._manageStamp = function(t) {
    ...
    for (var u = (
      ...
      ? o.top
      : o.bottom) + i.outerHeight, p = s; a >= p; p++)
...
function(t, e) {
  "function" == typeof define && define.amd
    ...
    : "object" == typeof exports
      ? module.exports = e(t, require("outlayer"), require("get-size"), require("desandro-matches-selector"), require("fizzy-ui-utils"), require("./item"), require("./layout-mode"), require("./layout-modes/masonry"), require("./layout-modes/fit-rows"), require("./layout-modes/vertical"))
