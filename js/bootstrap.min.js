...
/* ! Generated using the Bootstrap Customizer (http://getbootstrap.com/customize/?id=fd1fa1a31efb51d94eb8) Config saved to config.json and https://gist.github.com/fd1fa1a31efb51d94eb8 */
...
+ function(t) {
  ...
  o.prototype.enter = function(e) {
    ...
    return o && o.$tip && o.$tip.is(":visible")
      ...
      : (
        o || (o = new this.constructor(e.currentTarget, this.getDelegateOptions()), t(e.currentTarget).data("bs." + this.type, o)), clearTimeout(o.timeout), o.hoverState = "in", o.options.delay && o.options.delay.show
  ...
  o.prototype.show = function() {
    ...
    if (this.hasContent() && this.enabled) {
      ...
      if (l) {
        ...
        a = "bottom" == a && h.bottom + c > v.bottom
          ? "top"
          : "top" == a && h.top - c < v.top
            ? "bottom"
            : "right" == a && h.right + f > v.width
              ? "left"
              : "left" == a && h.left - f < v.left
                ? "right"
                : a,
  ...
  o.prototype.getViewportAdjustedDelta = function(t, e, o, i) {
    ...
    if (/right|left/.test(t)) {
      ...
      l < s.left
        ? n.left = s.left - l
        : h > s.width && (n.left = s.left + s.width - h)
    }
    return n
  },
  ...
  o.prototype.setContent = function() {
    ...
    t.find(".popover-content").children().detach().end()[
      this.options.html
        ? "string" == typeof o
          ? "html"
          : "append"
  ...
  o.prototype.activate = function(e, i, n) {
    ...
    s.length && a
      ? s.one("bsTransitionEnd", r).emulateTransitionEnd(o.TRANSITION_DURATION)
      : r(),
    s.removeClass("in")
  };
  var i = t.fn.tab;
